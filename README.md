...
### ANALYSIS CATEGORIES
This project explores real-world retail operations and customer analytics through SQL, focusing on:
- Customer Segmentation & Profiling  
- Sales & Product Performance  
- Customer Behavior & Retention  
- Store Growth & Financial Trends  
...
- insights: Explanations, insights, and results for each query  


### PROJECT BREAKDOWN
The project consists of **28 SQL business questions** divided into categories:
...
👉 You can view all 28 business questions and their detailed analysis in the **[Insights Folder]([insights/](https://github.com/EbukaOkoli01/Cal_Mart_SQL_Project/tree/main/Insights))** section.
